...
configurable_parameters = [{'name': 'camera_name',                  'default': 'cam1', 'description': 'camera unique name'},
                           ...
                           {'name': 'enable_confidence',            'default': 'false', 'description': 'enable confidence'},
